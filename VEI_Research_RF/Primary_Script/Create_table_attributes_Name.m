function [Tbl_VEI_allcat,Tbl_VEI_cat,Tbl_VEI_dom,Tbl_VEI_etd,Tbl_VEI_ed,Tbl_VEI_morph,Tbl_VEI_num,Tbl_VEI_tec,Tbl_unhistVEI_cat,Tbl_unhistVEI_dom,Tbl_unhistVEI_morph,Tbl_unhistVEI_tec] = Create_table_attributes_Name(eruption_data_clean_nan,volcano_data)
...
%Outputs: Tables of Attributes for each VEI and Time threshold 
    ...
    for l = 1:length(Volcano)
        ...
        for m = 1:length(L)
            ...
            Volcano(l).VolcanoName=volcano_data(L(m),:).VolcanoName;
    ...
    for k=1:length(Volcano)
        ...
        if (length(Volcano(k).eruption)>1)
            ...
            Volcano(k).secondVEI= [Volcano(k).eruption(2).vei];
    ...
    for iy = 1:8
        ...
        if iy == 1
            ...
            %Repose Time 
            Tbl_VEI_etd = table([matrix_volcano.currentVEI]',[matrix_volcano.eruptiontimediff]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','eruptiontimediff','volcanoname'});
        ...
        elseif iy == 2
            ...
            Tbl_VEI_ed = table([matrix_volcano.currentVEI]',[matrix_volcano.eruptionduration]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','eruptionduration','volcanoname'});
 
        elseif iy == 3
            matrix_VEI = [[Volcano.currentVEI]' [Volcano.secondVEI]' [Volcano.medianVEI]' [Volcano.modeVEI]' [Volcano.minVEI]' [Volcano.maxVEI]' [Volcano.eruptiontimediff]' [Volcano.eruptionduration]' [Volcano.silica]'];
            ...
            Tbl_VEI_num = table([matrix_volcano.currentVEI]',[matrix_volcano.secondVEI]',[matrix_volcano.medianVEI]',[matrix_volcano.modeVEI]',[matrix_volcano.minVEI]',[matrix_volcano.maxVEI]',[matrix_volcano.eruptiontimediff]',[matrix_volcano.eruptionduration]',[matrix_volcano.silica]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','secondVEI','medianVEI','modeVEI','minVEI','maxVEI','eruptiontimediff','eruptionduration','silica','volcanoname'});
        ...
        elseif iy == 4
            ...
            matrix_volcano = Volcano(indx_matrix);
            %Tectonic Setting 
            Tbl_VEI_tec=table([matrix_volcano.currentVEI]',[matrix_volcano.tectonicsetting]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','tectonicsetting','volcanoname'});
        ...
        elseif iy == 5
            ...
            %Dominant Petrology 
            Tbl_VEI_dom=table([matrix_volcano.currentVEI]',[matrix_volcano.rocktype]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','rocktype','volcanoname'});
        ...
        elseif iy == 6
            ...
            matrix_volcano = Volcano(indx_matrix);
            %Morphology 
            Tbl_VEI_morph=table([matrix_volcano.currentVEI]',[matrix_volcano.primaryvolcanotype]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','morphology','volcanoname'});
        ...
        elseif iy == 7
            ...
            Tbl_VEI_cat=table([matrix_volcano.currentVEI]',[matrix_volcano.rocktype]',[matrix_volcano.tectonicsetting]',[matrix_volcano.primaryvolcanotype]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','rocktype','tectonicsetting','morphology','volcanoname'});    

        else
            matrix_VEI = [[Volcano.currentVEI]' [Volcano.secondVEI]' [Volcano.medianVEI]' [Volcano.modeVEI]' [Volcano.minVEI]' [Volcano.maxVEI]' [Volcano.eruptiontimediff]' [Volcano.eruptionduration]'];
            ...
            Tbl_VEI_allcat=table([matrix_volcano.currentVEI]',[matrix_volcano.secondVEI]',[matrix_volcano.medianVEI]',[matrix_volcano.primaryvolcanotype]',[matrix_volcano.rocktype]',[matrix_volcano.tectonicsetting]',[matrix_volcano.minVEI]',[matrix_volcano.maxVEI]',[matrix_volcano.modeVEI]',[matrix_volcano.eruptiontimediff]',[matrix_volcano.eruptionduration]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','secondVEI','medianVEI','morphology','RockType','TectonicSetting','minVEI','maxVEI','modeVEI','eruptiontimediff','eruptionduration','volcanoname'});
        end
    end
    ...
    for iy = 1:4
        ...
        if iy == 1
            ...
            Tbl_unhistVEI_tec=table([matrix_volcano.currentVEI]',[matrix_volcano.tectonicsetting]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','tectonicsetting','volcanoname'});
        ...
        elseif iy == 2
            ...
            Tbl_unhistVEI_dom=table([matrix_volcano.currentVEI]',[matrix_volcano.rocktype]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','rocktype','volcanoname'});
        ...
        elseif iy == 3
            ...
            Tbl_unhistVEI_morph=table([matrix_volcano.currentVEI]',[matrix_volcano.primaryvolcanotype]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','morphology','volcanoname'});
            ...
            Tbl_unhistVEI_cat=table([matrix_volcano.currentVEI]',[matrix_volcano.rocktype]',[matrix_volcano.tectonicsetting]',[matrix_volcano.primaryvolcanotype]',[matrix_volcano.VolcanoName]','VariableNames',{'currentVEI','rocktype','tectonicsetting','morphology','volcanoname'});
        end
    end
