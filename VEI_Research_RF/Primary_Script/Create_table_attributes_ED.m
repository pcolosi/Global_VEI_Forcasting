...
%Outputs: Tables of Attributes for each VEI and Time threshold 
    ...
    for iy = 1:8
        ...
        elseif iy == 3
            matrix_VEI = [[Volcano.currentVEI]' [Volcano.medianVEI]' [Volcano.modeVEI]' [Volcano.minVEI]' [Volcano.maxVEI]' [Volcano.eruptiontimediff]' [Volcano.eruptionduration]' [Volcano.silica]' [Volcano.secondVEI]'];
            indx_matrix = find(isnan(matrix_VEI(:,1)) == 0 & isnan(matrix_VEI(:,2)) == 0 & isnan(matrix_VEI(:,3)) == 0 & isnan(matrix_VEI(:,4)) == 0 & isnan(matrix_VEI(:,5)) == 0 & isnan(matrix_VEI(:,6)) == 0 & isnan(matrix_VEI(:,7)) == 0 & isnan(matrix_VEI(:,8)) == 0);
            matrix_volcano = Volcano(indx_matrix);
 
            Tbl_VEI_num = table([matrix_volcano.currentVEI]',[matrix_volcano.secondVEI]',[matrix_volcano.medianVEI]',[matrix_volcano.modeVEI]',[matrix_volcano.minVEI]',[matrix_volcano.maxVEI]',[matrix_volcano.eruptiontimediff]',[matrix_volcano.eruptionduration]',[matrix_volcano.silica]','VariableNames',{'currentVEI','secondVEI','medianVEI','modeVEI','minVEI','maxVEI','eruptiontimediff','eruptionduration','silica'});
        ...
        elseif iy == 7
            ...
            matrix_VEI = [[Volcano.currentVEI]' [Volcano.medianVEI]' [Volcano.modeVEI]' [Volcano.minVEI]' [Volcano.maxVEI]' [Volcano.eruptiontimediff]' [Volcano.eruptionduration]' [Volcano.secondVEI]'];
